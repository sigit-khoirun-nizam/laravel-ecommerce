        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <div class="menu-inner-shadow"></div>
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item {{ Request::is('admin/all-category')? "active":"" }}">
                        ...
                        <li class="menu-item {{ Request::is('admin/add-subcategory')? "active":"" }}">
                        ...
                        <li class="menu-item {{ Request::is('admin/all-subcategory')? "active":"" }}">
                        ...
                        <li class="menu-item {{ Request::is('admin/all-products')? "active":"" }}">
